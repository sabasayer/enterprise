import { IApiRequestOptions, ServiceRequest } from "@sabasayer/enterprise";
...
export type SavePatientServiceRequest = ServiceRequest<SavePatientRequest,SavePatientResponse>
