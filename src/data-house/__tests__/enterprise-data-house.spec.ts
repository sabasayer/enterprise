...
describe("Enterprise Data House", () => {
    ...
    it("should remove items", () => {
        ...
        EnterpriseDataHouse.instance.removeItems<{ id: number }>(EnumCacheType.Memory, 'test2', (e) => e.id == 2);
        const result = EnterpriseDataHouse.instance.get(EnumCacheType.Memory, 'test2');
    ...
    it("should add items", () => {
        ...
        EnterpriseDataHouse.instance.addItems<{ id: number }>(EnumCacheType.Memory, 'test3', newData);

        const result = EnterpriseDataHouse.instance.get(EnumCacheType.Memory, 'test3');
